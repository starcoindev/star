...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 850 * COIN;

            if(nBestHeight == 0)
            {
            nSubsidy = 513731707 * COIN;
            }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1465685184, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        block.nVersion = 1;
        block.nTime    = 1465685184;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1035742 : 1035742;
        ...
        assert(block.hashMerkleRoot == uint256("0x75cf7d485eb3784df1b5f742bd4609b3eb7600d431750a1a125e1ff5115c9851"));
...
unsigned char pchMessageStart[4] = { 0x5e, 0x5b, 0x1d, 0x99 };
